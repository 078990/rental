...
CREATE TABLE `addproperty` (
  ...
  `ptype` varchar(13) NOT NULL,
  `pcode` int(13) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `property` (`id`, `Names`, `Phone`, `email`) VALUES
(1, 'ines', 786697640, 'inestoni25@gmai'),
(2, 'ines', 786697640, 'inestoni25@gmai'),
(3, 'ines ', 78900055, 'inestoni25@gmai'),
(4, 'ines ', 725611643, 'julien@gmail.co');
...
(37, 'nene', 'inestoni25@gmail.com', '0786697640', '749bc367fd90880f2d6dbe578e98e14645b0b26d', 'agent', 'Screenshot 2024-03-01 192125.png'),
(38, 'ines', 'inestoni5@gmail.com', '0786697640', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'user', 'a.jpg');
