...
<!--	Title
	=========================================================-->
<title>Primier Real Estate</title>
</head>
<body>
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">kk233 Street, kacyiru</span> <br>
										<span class="text-white">kk341 Street, kacyiru</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+250789098</span>
										<span class="text-white">+2507890098 </span>
									</div>
                                </li>
