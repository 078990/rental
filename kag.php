    ...
    <div class="row"> 
        ...
        <!--    Banner   --->
         ...
         <!--   Banner   --->
                     ...
                     <div class="slide">
    <figure>
        <img src="images/kag1.jpg">
        <img src="images/kag2.jpg">
        <img src="images/kag3.jpg">
        <img src="images/kag4.jpg">
        <img src="images/kag5.jpg">
    </figure>
...
<p>Bedroom:2</p>
<p>Bathroom:2</p>
<p>Address:Kigali city,Gasabo,kagugu</p>
<br><br>
...
<p>Email: inestoni25@gmail.com</p>
                  ...
                  <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Get in touch</h4>
                        <form class="d-inline-block w-100" action="req.php" method="POST">
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-number">+250</div>
                                </div>
                            ...
                            <div class="input-group mb-2 mr-sm-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text"><i class="far fa-email-alt"></i></div>
                                </div>
